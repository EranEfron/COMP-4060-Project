...
export async function uploadFile (func,patient,file){
  ...
  //   .submit(patient);
  let response1 = await SmartContractUtil.evaluateTransaction('MedicalRecordsContract', func, patientArg, gateway);
  // console.log(isexist)
