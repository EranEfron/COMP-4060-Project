  ...
  <el-container class="homecontainer">
    ...
    <el-main height="300px">
      ...
      <h1>Search Medical record</h1>
        <div class="posts">
                <el-input v-model="input" placeholder="Enter patient username" size="0px"  style="width:450px"></el-input>
        ...
        <el-table :data="tableData" :align="center" style="width: 1000px" :default-sort="{ prop: 'date', order: 'descending' }">
  ...
  methods: {
    async queryByID() {
      ...
      if (!this.input.username) {
        let response = 'Please enter a username.';
        // this.input.data = response;
      } else {
        // const apiResponse = await PostsService.download(this.input.username)
      }
