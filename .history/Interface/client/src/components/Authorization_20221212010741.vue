        ...
        <el-main height="300px">
            ...
            <div class="posts">
                <form v-on:submit="queryByID">
                    <input type="text" v-model="input.ID" placeholder="Enter docter's username">
                    <br>
                ...
                <el-table :data="tableData" style="width: 100%" :default-sort="{ prop: 'time', order: 'descending' }">
                    ...
                    <el-table-column prop="time" label="Access given time">
                    </el-table-column>
...
export default {
    ...
    data() {
        return {
            ...
            tableData: [{name:"Dr.Joe",time:"Nov,21,2022"}]
        };
    },
