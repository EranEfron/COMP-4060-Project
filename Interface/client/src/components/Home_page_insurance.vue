<template >
  <el-container class="homecontainer">
    <el-header>
      <div class="head">
        <el-menu class="el-menu-demo" mode="horizontal" text-color="#333" active-text-color="#545c64">
          <el-menu-item index="1"><router-link to="/home_page_insurance">Home</router-link></el-menu-item>
          <el-menu-item index="2"><router-link to="/Download_insurance">Download</router-link></el-menu-item>
        </el-menu>
      </div>
    </el-header>
    <el-main height="300px">
      ...
      <h1>Welcome to EMR system (Insurence)</h1>
