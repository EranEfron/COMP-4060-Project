<template >
  <el-container class="homecontainer">
    ...
    <el-main height="300px">
      ...
      <h1>Query Medical record</h1>
      <div class="posts">
        <form v-on:submit="queryByID">
          <input type="text" v-model="input.username" placeholder="Enter username to Query">
          <br>
        ...
        <el-table :data="tableData" style="width: 100%" :default-sort="{ prop: 'date', order: 'descending' }">
          ...
          <el-table-column align="center" label="Action">
            <template slot-scope="scope">
              <el-button @click="downLoad(scope.row)" type="text">Download</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
